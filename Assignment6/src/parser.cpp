...
Statement *parseStatement(TokenScanner & scanner) {
   ...
   if (firstToken == "PRINT") return new PrintStmt(scanner);
   if (firstToken == "REM") return new RemStmt(scanner);
   if (firstToken == "LET") return new LetStmt(scanner);
   if (firstToken == "INPUT") return new InputStmt(scanner);
   if (firstToken == "GOTO") return new GotoStmt(scanner);
   if (firstToken == "IF") return new IfStmt(scanner);
   if (firstToken == "END") return new EndStmt(scanner);
   return NULL;
}
